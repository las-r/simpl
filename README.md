...
## SIMPL (Super Implementable and Minimalist Programming Language)
...
You can read the specification [here](https://github.com/las-r/simpl/blob/main/simpl/SPEC.md).

## CMPLEx (Complementary Modular Programming Language Extras)
...
You can read the specification [here](https://github.com/las-r/simpl/blob/main/cmplex/SPEC.md).