...
I've included an example of a SIMPL interpreter in this folder, but it's recommended to only use it as a reference to aid in the making of your own interpreter.
